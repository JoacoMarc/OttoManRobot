...
def main(argv=None) -> int:
    ...
    ap.add_argument("--sin-teclado", action="store_true",
                    help="no dejes manejar el robot con el teclado de la ventana")
    ...
    try:
        if args.sin_ventana or not hay_ventana:
            ...
            # Las teclas las reparte el visor, asi que esto solo se anuncia
            # cuando la ventana va a abrir de verdad.
            if not args.sin_teclado:
                from .teclado import AYUDA
                print(AYUDA)
                print()
